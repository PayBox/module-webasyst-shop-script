 ...
 */
class payboxPayment extends waPayment implements waIPayment, waIPaymentCancel, waIPaymentRefund
{
	private $order_id;
	private $url = 'https://api.paybox.money/payment.php';
	...
	protected function init()
    {
        ...
        $autload->add("PG_Signature", "wa-plugins/payment/paybox/lib/PG_Signature.php");
        return parent::init();
    }
